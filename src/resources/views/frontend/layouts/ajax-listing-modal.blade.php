    ...
    <div class="col-12 col-xl-12 col-md-12">
        <div class="map_popup_content">
            ...
            <div class="map_popup_text">
                ...
                <span><i class="far fa-star"></i> Destacado</span>
                @endif
                @if ($listing->is_verified)
                <span class="red"><i class="far fa-check"></i> Verificado</span>
                @endif
                <h5>{{ $listing->title }}</h5>
                ...
                <a class="read_btn" href="{{ route('listing.show', $listing->slug) }}">Leer más</a>
            </div>
        </div>
    </div>
