                                    ...
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            ...
                                            <select name="status" class="form-control" required>
                                                <option @selected($listing->status === 1) value="1">Activo</option>
                                                <option @selected($listing->status === 0) value="0">Inactivo</option>
                                            </select>
                                        </div>
                                    </div>
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            ...
                                            <select name="is_featured" class="form-control" required>
                                                ...
                                                <option @selected($listing->is_featured === 1) value="1">Sí</option>
                                            </select>
                                        </div>
                                    </div>
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            ...
                                            <select name="is_verified" class="form-control" required>
                                                ...
                                                <option @selected($listing->is_verified === 1) value="1">Sí</option>
                                            </select>
                                        </div>
                                    </div>
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            ...
                                            <select name="is_previliged" class="form-control" required>
                                                <option @selected($listing->is_previliged === 0) value="0">No</option>
                                                <option @selected($listing->is_previliged === 1) value="1">Sí</option>
                                            </select>
                                        </div>
                                    </div>
                                </div>
