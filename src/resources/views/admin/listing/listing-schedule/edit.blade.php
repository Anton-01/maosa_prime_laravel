    ...
    <section class="section">
        <div class="section-header">
            ...
            <div class="section-header-breadcrumb">
                ...
                <div class="breadcrumb-item"><a href="{{ route('admin.listing-schedule.index', $schedule->listing_id) }}">Horario - Proveedor</a></div>
                        ...
                        <div class="card-body">
                            <form action="{{ route('admin.listing-schedule.update', $schedule->id) }}" method="POST" enctype="multipart/form-data">
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label for="">Horario inicio<span class="text-danger">*</span></label>
                                            <input type="text" class="form-control timepicker-1" name="start_time" >
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label for="">Horario fin<span class="text-danger">*</span></label>
                                ...
                                <div class="form-group">
                                    ...
                                    <select name="status" class="form-control">
                                        <option @selected($schedule->status === 1) value="1">Activo</option>
                                        <option @selected($schedule->status === 0) value="0">Inactivo</option>
                                    </select>
                                </div>
