                ...
                <div class="col-12">
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <div class="price-table-preview" style="max-width: 700px; margin: 0 auto; font-family: Arial, sans-serif;">
                                <table style="width: 100%; border-collapse: collapse; font-size: 13px;">
                                    <thead>
                                    <tr>
                                        <th colspan="4" style="background: #1a472a; color: white; padding: 10px; text-align: center; font-size: 16px; font-weight: bold;">
                                            ESTIMADO {{ strtoupper($priceList->user->name) }}
                                        </th>
                                    </tr>
                                    <tr>
                                        <th colspan="4" style="background: #1a472a; color: white; padding: 5px; text-align: center; font-size: 12px;">
                                    ...
                                    <tr style="background: #333; color: white;">
                                        ...
                                        <th style="padding: 8px; text-align: center; border: 1px solid #ddd; background: #333; width: 100px;">DIÉSEL</th>
                                    </tr>
                                    </thead>
                                    <tbody>
