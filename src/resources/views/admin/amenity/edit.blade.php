    ...
    <section class="section">
        <div class="section-header">
            ...
            <div class="section-header-breadcrumb">
                ...
                <div class="breadcrumb-item"><a href="{{ route('admin.amenity.index') }}">Servicios</a></div>
                            ...
                            <form action="{{ route('admin.amenity.update', $amenity->id) }}" method="POST" enctype="multipart/form-data">
                                ...
                                <div class="form-group">
                                    ...
                                    <select name="status" class="form-control">
                                        <option @selected($amenity->status === 1) value="1">Activo</option>
                                        <option @selected($amenity->status === 0) value="0">Inactivo</option>
                                    </select>
                                </div>
